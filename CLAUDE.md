...
- **[WAKING-TRAINER](docs/substrate/WAKING-TRAINER-native-waking-trainer-skeleton.md)** — ree_core-owned native waking trainer skeleton (per-member optimizer groups, stepped from update_residue, gradient-reach guard raises) + e3.harm_eval_head member -- IMPLEMENTED default-OFF (2026-09-25) *(~600 tok)*
