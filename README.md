...
- **SD-039 substrate**: Dual-trace anchor goal-snapshot payload — `AnchorGoalPayload` dataclass (z_goal_snapshot + wanting_strength + arousal_tag + last_vs + staleness_at_write + payload_written_step); refresh-on-invalidate semantic preserves payload across `mark_inactive`; `Anchor.goal_match` cosine helper + `AnchorSet.query_by_goal_match` active+inactive dual-trace getter for the MECH-292 consumer; module-level write-site population (from GoalState / VALENCE_WANTING / amygdala arousal tags) and validation EXQ deferred to a follow-on session (substrate landed 2026-04-26).
...
551 runner-side completions (per `runner_status.json` 2026-04-26 read: 109 PASS / 241 FAIL / 66 ERROR / 135 UNKNOWN; v3 subset: 93 PASS / 228 FAIL / 66 ERROR / 135 UNKNOWN). SD-004 through SD-023 implemented plus SD-016, ARC-033, MECH-090 (bistable + Layer 1 stepping) + MECH-091 Layer 2 urgency interrupt, MECH-120, MECH-203/204, MECH-205, MECH-216, the **SD-032 cingulate cluster (a/b/c/d/e, all landed 2026-04-19)**, **SD-033a lateral-PFC-analog (MECH-261 primary consumer, landed 2026-04-20, V3-EXQ-456 PASS)**, the **SD-034 governance closure-operator / MECH-267 mode-conditioned hippocampal / MECH-268 dACC conflict-saturation cluster (landed 2026-04-20 through 2026-04-21)**, the **MECH-266 asymmetric per-mode hysteresis extension on SalienceCoordinator (landed 2026-04-21)**, the **SD-029 curriculum-level balanced hazard-event support in CausalGridWorldV2 (landed 2026-04-21)**, the **SD-035 amygdala-analog peer modules (BLA + CeA, landed 2026-04-21; V3-EXQ-473/474 PASS)**, the **2026-04-22 V_s invalidation runtime wave: SD-036 GABAergic cross-stream decay regulator + MECH-279 PAG freeze-gate, MECH-269 Phase 1 per-stream V_s foundation, MECH-288 event segmenter Phase 2, MECH-287 invalidation trigger Phase 2 iv, MECH-269 Phase 2 ii AnchorSet substrate, MECH-269 Phase 2 iii T4 per-region V_s readout**, the **2026-04-24 Phase 3 wave: MECH-284 staleness accumulator + MECH-269 online hysteresis swap + MECH-290 backward trajectory credit sweep**, the **2026-04-25 substrate wave: SD-037 BroadcastOverrideRegulator (orexin-analog) + Sleep Aggregation Cluster Phases A-E (SleepLoopManager scaffolding, MECH-285 SleepReplaySampler, MECH-272 RoutingGate, MECH-275 BayesianAggregator, MECH-273 SelfModelAggregator + StalenessAccumulator.partial_decay) + SD-016 Path 1 ContextMemory diversification loss**, and the **2026-04-26 substrate wave: SD-039 dual-trace anchor goal-snapshot payload (substrate-side foundation for the MECH-292 ranked ghost-goal bank), SD-033b OFC-analog as the MECH-261 second consumer, MECH-269b symmetric V_s gating on E1/E2 cortical rollouts (read-side consumer of MECH-269 Phase 1; precondition use_per_stream_vs=True), MECH-295 weak-reading drive -> liking-stream -> approach_cue bridge, plus the ARC-054 v4 -> v3 promotion in synaptic-EMA form and the MECH-271 V3 substrate plan (routing table + audit hook)**. **SD-003 superseded 2026-04-18** by MECH-256 + SD-029 + MECH-257; SD-030/SD-031 deferred to V4. SD-033e frontopolar-analog V4-reserved stub landed 2026-04-21. MECH-270 (ephaptic substrate of V_s) + MECH-274 (V4 other-attribution aggregation) + MECH-276/277/278 + ARC-059 (scientist-agent developmental ordering cluster) remain v3_pending; MECH-272/273/275/285 substrate landings completed 2026-04-25 via the Sleep Aggregation Cluster (Phases A-E); MECH-271 V3 substrate plan committed 2026-04-26 (V4 ephaptic-field-strength routing stays v4-by-design). Regression suite PRs 1-5 remain live (preflight + contracts + deferred changed layers, `/api/regression/preflight` endpoint, explorer preflight badge, pre-commit contracts hook); contracts suite at **164/164 PASS + 7/7 preflight PASS** with all flags OFF after the 2026-04-26 wave -- bit-identical-when-OFF guarantee preserved. **Queue (`experiment_queue.json` 2026-04-27): 6 items**. V3-EXQ-433d (SD-029 / MECH-256 event-conditioned comparator with the EXQ-479 calibrated curriculum; supersedes V3-EXQ-433c) is **in flight** -- auto-claimed by DLAPTOP-4.local 2026-04-26T15:01Z. Pending: V3-EXQ-418e (SD-016 Path 1 4-arm; supersedes V3-EXQ-418d), V3-EXQ-484 (SD-033a distractor-resistance under MECH-261 internal_replay gate; smoke PASS), V3-EXQ-485 (SD-033b OFC-analog landing diagnostic; smoke PASS), V3-EXQ-490 (MECH-269b symmetric V_s gating; Q-040 factorial ON_OFF vs ON_ON), V3-EXQ-493 (MECH-295 weak-reading bridge validation including UC5 SEVERED-BRIDGE COLLAPSE; smoke PASS). Pending review queue regenerated 2026-04-26T16:19:34Z carries **0 items** -- the 2026-04-26T15:39 governance cycle reclassified V3-EXQ-483a `supports -> non_contributory` per-claim (SD-037 / MECH-280 / MECH-281 remain `hold_pending_v3_substrate`) and applied 9 `hold_pending_v3_substrate` decisions (ARC-051, ARC-060, MECH-269b, MECH-291, MECH-292, MECH-293, MECH-294, MECH-295, SD-039). Current focus: V3-EXQ-490 + V3-EXQ-493 jointly dissect the EXQ-483 wired-but-inert pattern via the Q-040 factorial -- V3-EXQ-490 PASS recovers approach_commit and reopens SD-037; V3-EXQ-490 FAIL on C2/C3 with C1 PASS redirects to MECH-295 as dominant blocker; V3-EXQ-493 separately validates the liking-bridge mechanism + the severed-bridge falsification. V3-EXQ-433d gates the SD-003 successor track; V3-EXQ-418e gates the SD-016 cue_action_proj forward-path re-validation. Open promotion blockers documented in claims.yaml: MECH-294 within-cycle-vs-cross-cycle binding (Kay 2020 challenge); MECH-295 strong-vs-weak liking-bridge necessity (weak reading committed provisionally).
