...
- **2026-07-20T01:11Z nightly read (scheduled `/update-docs`, bot identity).**
  ...
  **Currently queued (`experiment_queue.json` items[]): 8 items** -- **V3-EXQ-787** (priority 60; `claim_id=MECH-463`; hazard-geometry probe testing H-endogenous-hazard-geometry as the arousal-variance-amplifier substrate face; CLAIMED; autopsy already ELIMINATED the leg 3/3 -- `b9babbe180`), **V3-EXQ-788** (priority 55; `claim_id=MECH-457`; GOV-FANOUT-1 retention leg **H-retention-critic** on the newly-landed `mech457_retention_trajectory_probe` substrate; `machine_affinity ree-cloud-2`; PENDING), **V3-EXQ-789** (priority 55; `claim_id=MECH-457`; GOV-FANOUT-1 retention leg **H-retention-auxiliary-decay** on the same substrate; `machine_affinity ree-cloud-3`; PENDING), **V3-EXQ-699a** (priority 5; `claim_id=MECH-448`; re-run of V3-EXQ-699 for adjudicable preconditions after the 2026-07-19 declaration fix `0bfbb42`; smoke PASS; CLAIMED -- `3065054`), plus four MECH-457 lineage same-family-suffix retest items **V3-EXQ-742a / 737a / 728a / 734a** (priorities 45/40/35/30; ANY affinity; queued after `interesting-noether-3f6326` `zworld guard fanout` claim reissued the 728/734/737/742 z_world-guard fanout).
