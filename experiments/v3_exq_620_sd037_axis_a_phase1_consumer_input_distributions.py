...
"""
V3-EXQ-620: SD-037 axis (a) Phase 1 substrate-readiness diagnostic.
...
EXPERIMENT_TYPE = "v3_exq_620_sd037_axis_a_phase1_consumer_input_distributions"
QUEUE_ID = "V3-EXQ-620"
CLAIM_IDS: List[str] = []
EXPERIMENT_PURPOSE = "diagnostic"
...
def run_experiment(
    *,
    ...
    # Overall outcome: PASS iff every quantity has at least one observation across
    # the pooled distribution AND none of them is degenerately all-zero. Pure
    # measurement check -- the experiment does not test a scientific hypothesis.
    overall_pass = True
    for qkey, _ in MEASURED_QUANTITIES:
