...
"""V3-EXQ-603d -- Q-045 MECH-313 + MECH-260 + FP-2 matched-noise dissociation
on the scaffolded_sd054_onboarding substrate.

Supersedes V3-EXQ-603c (the four-iteration 603 chain stalled on the three
GAP-C substrate prereqs, all of which have now cleared):
...
Smoke
-----
    /opt/local/bin/python3 experiments/v3_exq_603d_q045_mech313_mech260_scaffolded_sd054.py --dry-run
...
EXPERIMENT_TYPE = "v3_exq_603d_q045_mech313_mech260_scaffolded_sd054"
QUEUE_ID = "V3-EXQ-603d"
CLAIM_IDS = ["Q-045", "MECH-313", "MECH-260"]
EXPERIMENT_PURPOSE = "evidence"
EXPERIMENT_PURPOSE_TAG = "evidence"
...
# Scheduler P0 / P1 budgets. Sized below the scheduler's defaults (30/30/30)
# to keep the full 5-arm x 3-seed matrix tractable on a single runner; P0
# warmup is bounded because the scheduler's reef-refuge spawn does most of
# the survival-grooming work, so additional encoder warmup ticks have
# diminishing returns.
SCAFFOLD_P0_BUDGET = 30
SCAFFOLD_P1_BUDGET = 30
