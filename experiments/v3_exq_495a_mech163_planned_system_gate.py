...
"""V3-EXQ-495a: MECH-163 V3 Full-Completion Gate -- VTA / Hippocampally-Planned Arm

Supersedes V3-EXQ-495 (SIGTERM after ~4h on ree-cloud-1 -- undersized CX22
platform restart, not a code path; no manifest produced). Re-queued unchanged
in design per EXQ versioning policy; machine_affinity "any" (cloud-1 is now the
excluded hub, surviving workers carry Phase-3 SIGTERM protection).
...
# Experiment metadata
# ---------------------------------------------------------------------------
EXPERIMENT_TYPE    = "v3_exq_495a_mech163_planned_system_gate"
SUPERSEDES         = "V3-EXQ-495"
CLAIM_IDS          = ["MECH-163"]
EXPERIMENT_PURPOSE = "evidence"
