"""
V3-EXQ-887: SD-014 hippocampal node-valence vector -- REPRESENTATIONAL separability
and FUNCTIONAL drive-gated replay prioritisation (wall-independent confirming DV).
...
EXPERIMENT_TYPE = "v3_exq_887_sd014_node_valence_representational_functional"
...
def _run_waking_rollout(agent, env, n_episodes, n_steps, seed) -> Dict:
    ...
    for ep in range(n_episodes):
        ...
        for _step in range(n_steps):
            ...
            agent.update_benefit_salience(benefit_exposure)   # -> VALENCE_WANTING
