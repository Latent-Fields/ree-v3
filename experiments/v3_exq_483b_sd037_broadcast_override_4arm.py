"""
V3-EXQ-483b -- SD-037 Broadcast Override Regulator (orexin-analog) 4-arm validation
                 (longer-warmup successor to V3-EXQ-483)

Corrected rerun fixing BreathOscillator-disabled bug (Bug 1: breath_period=0 in all
prior runs). Note: Bug 2 (_committed_step_idx saturation) does not apply to the
bistable path (beta_gate_bistable=True) used in this experiment.

Supersedes: V3-EXQ-483a
...
EXPERIMENT_TYPE    = "v3_exq_483b_sd037_broadcast_override_4arm"
EXPERIMENT_PURPOSE = "diagnostic"
