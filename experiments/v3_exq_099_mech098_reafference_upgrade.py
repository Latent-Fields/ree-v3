...
Claims: MECH-098
Supersedes: conceptually addresses root cause of EXQ-069, EXQ-082 FAILs
...
EXPERIMENT_TYPE = "v3_exq_099_mech098_reafference_upgrade"
CLAIM_IDS = ["MECH-098"]
...
def run(
    ...
    **kwargs,
    ...
    print(
        f"\n[V3-EXQ-099] MECH-098 reafference upgrade experiment"
    ...
    if not c1_pass:
        ...
        print(f"\n[V3-EXQ-099] Phase 1 FAIL: {note}", flush=True)
    ...
    print(
        f"\n[V3-EXQ-099] Phase 1 PASS: R2_test={r2_test:.4f} >= {gate_threshold:.2f}."
        " Proceeding to discriminative pair.",
        flush=True,
    )

    # ----- Phase 2: discriminative pair -----
    print("\n[V3-EXQ-099] Phase 2 -- REAF_ON run...", flush=True)
    ...
    print("\n[V3-EXQ-099] Phase 2 -- REAF_OFF run...", flush=True)
    ...
    print(f"\n[V3-EXQ-099] Final results:", flush=True)
    print(
    ...
    summary_markdown = (
        f"# V3-EXQ-099 -- MECH-098 Reafference Upgrade Gate + Discriminative Pair\n\n"
        f"**Status:** {status}\n"
        f"**Claims:** MECH-098\n"
        f"**Seed:** {seed}\n"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="V3-EXQ-099 MECH-098 reafference upgrade gate + discriminative pair"
    )
    ...
    if args.smoke_test:
        ...
        print("[V3-EXQ-099] SMOKE TEST MODE", flush=True)
    else:
    ...
    if args.smoke_test:
        print("[V3-EXQ-099] SMOKE TEST COMPLETE", flush=True)
        for k in [
