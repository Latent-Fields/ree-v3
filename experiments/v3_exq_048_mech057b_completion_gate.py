...
EXPERIMENT_TYPE = "v3_exq_048_mech057b_completion_gate"
CLAIM_IDS = ["MECH-057b"]
...
def _eval_beta_gate(
    ...
    total_propagation_ops = hold_count + prop_count
...
def run(
    ...
    **kwargs,
    ...
    print(
        f"[V3-EXQ-048] MECH-057b: Trajectory Completion Gate\n"
    ...
    print(f"\nV3-EXQ-048 verdict: {status}  ({criteria_met}/5)", flush=True)
