...
"""
V3-EXQ-445f -- SD-032b dACC: Reef-Enriched Substrate.

Claims: SD-032b, MECH-258, MECH-260
Supersedes: V3-EXQ-445c (non_contributory due to monostrategy: even in the
...
EXPERIMENT_TYPE = "v3_exq_445f_sd032b_dacc_reef"
CLAIM_IDS = ["SD-032b", "MECH-258", "MECH-260"]
EXPERIMENT_PURPOSE = "evidence"
...
def main():
    ...
    output = {
        ...
        "supersedes": "v3_exq_445c_sd032b_dacc_larger_env",
        "claim_ids": CLAIM_IDS,
