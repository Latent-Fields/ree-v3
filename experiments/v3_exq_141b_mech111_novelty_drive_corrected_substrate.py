...
"""
V3-EXQ-141b -- MECH-111 Novelty/Curiosity Drive: Corrected-Substrate Retest

Claims: MECH-111
Proposal: EVB-0061 (re-evaluation on corrected substrate)
Supersedes: V3-EXQ-141 (FAIL/weakens 2026-03-29; reclassified substrate-confounded
  2026-05-08 after the MECH-307 anticipatory-affect-conjunction analysis showed
  the same wiring gaps that prevent excitement-as-derived-state likely also
  prevent novelty-positive-anticipation from forming the upstream signal that
  MECH-111's commit-threshold-modulation gates on).
...
EXPERIMENT_TYPE = "v3_exq_141b_mech111_novelty_drive_corrected_substrate"
CLAIM_IDS = ["MECH-111"]
...
if __name__ == "__main__":
    ...
    result["supersedes"] = "v3_exq_141_mech111_novelty_drive_pair"
    result["substrate_correction_note"] = (
        "Retests MECH-111 on the post-2026-04-15 commit-chain-corrected "
        "substrate (BreathOscillator + _committed_step_idx + Q-042 running_variance "
        "fixes all landed). EXQ-141 (2026-03-29) FAIL/weakens reclassified as "
        "substrate-confounded by 2026-05-08 MECH-307 analysis. If 141b PASSes "
        "or partial-PASSes, MECH-111 remains live; if it FAILS again, the "
        "MECH-307 conjunction-fix substrate is the next architectural lever."
    )
