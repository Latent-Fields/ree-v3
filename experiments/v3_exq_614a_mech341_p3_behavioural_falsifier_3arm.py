...
"""
V3-EXQ-614a -- GAP-B Phase P3 behavioural falsifier: B_only / ablate_B / ALL_ON.

Re-queue of V3-EXQ-614 (post 2026-05-29T19:13:19Z manifest-pipeline silent-drop).

V3-EXQ-614 was queued 2026-05-29T17:00Z (ree-v3 commit 62c45e9). Coordinator DB
shows status=completed at 2026-05-29T19:13:19Z (updated_at; no claimed_by_machine,
no claimed_at), but the results table has zero rows for V3-EXQ-614 and no
manifest landed under REE_assembly/evidence/experiments/. Same silent-drop
signature as V3-EXQ-490h and V3-EXQ-592b (autopsied 2026-05-30T06:02Z). The
runner-side fix at ree-v3 commit 41c3411 'runner: fix V3-EXQ-592b FAIL/ERROR
silent-drop' landed AFTER V3-EXQ-614 had already vanished, so V3-EXQ-614 was
the third victim of the same bug. See REE_assembly/evidence/planning/
failure_autopsy_V3-EXQ-490h-V3-EXQ-592b_2026-05-30.md (cluster artifact, amended
with V3-EXQ-614 absorption).

Bit-identical script body to V3-EXQ-614; only EXPERIMENT_TYPE / QUEUE_ID /
SUPERSEDES constants + this docstring header change. claim_ids unchanged
(MECH-341 + ARC-065) -- the science is identical; only the pipeline bug was the
difference between predecessor and successor. Runs against the now-fixed
runner (post commit 41c3411).

Original V3-EXQ-614 charter (unchanged below)
---------------------------------------------
...
EXPERIMENT_TYPE = "v3_exq_614a_mech341_p3_behavioural_falsifier_3arm"
QUEUE_ID = "V3-EXQ-614a"
SUPERSEDES = "V3-EXQ-614"
