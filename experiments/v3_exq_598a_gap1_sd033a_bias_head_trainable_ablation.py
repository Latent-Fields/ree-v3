...
"""V3-EXQ-598a: commitment_closure GAP-1 -- SD-033a bias-head trainable ablation.

Supersedes V3-EXQ-598 (ERROR on ree-cloud-2: script not yet on disk when runner
claimed the experiment; git sync lag between push at 14:37Z and last pull at 13:18Z
on 2026-05-21). No code changes from 598. Re-queued as 598a per EXQ versioning policy.
...
EXPERIMENT_TYPE = "v3_exq_598a_gap1_sd033a_bias_head_trainable_ablation"
EXPERIMENT_PURPOSE = "evidence"
QUEUE_ID = "V3-EXQ-598a"
SUPERSEDES = "V3-EXQ-598"
...
def main() -> None:
    ...
    acc = result["acceptance"]
    print("\n=== V3-EXQ-598a SUMMARY ===", flush=True)
