...
# Supersedes V3-EXQ-680: that run's P0 optimizer held only the head params, so
# the gradient flowing into the shared encoder (latent_stack) was computed and
# DISCARDED -- the encoder never trained, integration was inert, and iso == pair
# by construction (delta ~ 0 / byte-identical on 2/3 seeds). 680a puts the
# encoder in the P0 optimizer (the integration locus actually learns) + a
# floor-based integration-effect degeneracy guard.
SUPERSEDES = "v3_exq_680_mech423_superadditivity_ablation"
