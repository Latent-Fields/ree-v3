...
"""V3-EXQ-569b -- SD-056 action-contrastive matched-entropy FP-2 falsifier.
...
Smoke
-----
  /opt/local/bin/python3 experiments/v3_exq_569b_sd056_action_contrastive_diversity_falsifier.py --dry-run
"""
...
EXPERIMENT_TYPE = "v3_exq_569b_sd056_action_contrastive_diversity_falsifier"
QUEUE_ID = "V3-EXQ-569b"
CLAIM_IDS: List[str] = ["ARC-065", "MECH-341"]
EXPERIMENT_PURPOSE = "evidence"
SUPERSEDES = "V3-EXQ-569a"
