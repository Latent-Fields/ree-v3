...
"""
V3-EXQ-445h -- SD-032b dACC: Reef-Enriched Substrate (bias calibration fix).
...
EXPERIMENT_TYPE = "v3_exq_445h_sd032b_dacc_reef"
CLAIM_IDS = ["SD-032b", "MECH-258", "MECH-260"]
EXPERIMENT_PURPOSE = "evidence"
...
def main():
    ...
    output = {
        ...
        "supersedes": "v3_exq_445g_sd032b_dacc_reef",
        "claim_ids": CLAIM_IDS,
