...
EXPERIMENT_TYPE = "v3_exq_397_arc007_path_memory_ablation"
...
def run(
    ...
    **kwargs,
    ...
    print(
        f"[V3-EXQ-397] ARC-007 Path Memory Ablation\n"
    ...
    print("[V3-EXQ-397] Residue field restored.", flush=True)

    # Phase 6: Eval C — restored
    print("[V3-EXQ-397] Eval C (restored residue field)...", flush=True)
    ...
    print(f"\nV3-EXQ-397 verdict: {status}  ({criteria_met}/5)", flush=True)
    ...
    summary_markdown = f"""# V3-EXQ-397 — ARC-007 Path Memory Ablation (Proper)
