"""V3-EXQ-840: MECH-294 behavioural falsifier -- joint vs alternation vs shuffled
...
Usage:
  /opt/local/bin/python3 experiments/v3_exq_840_mech294_theta_packet_binding_committed_action_falsifier.py --dry-run
"""
...
EXPERIMENT_TYPE = "v3_exq_840_mech294_theta_packet_binding_committed_action_falsifier"
QUEUE_ID = os.environ.get("REE_QUEUE_ID") or "V3-EXQ-840"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "V3-EXQ-840 MECH-294 behavioural falsifier: joint/alternation/shuffled "
            "theta-burst binding, per-candidate coherence routed via the route-range "
            "authority, committed-action distribution readout"
        )
    )
