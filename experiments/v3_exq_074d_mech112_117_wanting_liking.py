...
"""
V3-EXQ-074d -- MECH-117 Wanting/Liking Dissociation (navigation-seeded fix)

Claims: MECH-112, MECH-117
Supersedes: V3-EXQ-074c
...
EXPERIMENT_TYPE = "v3_exq_074d_mech112_117_wanting_liking"
...
def run(
    ...
    **kwargs,
    ...
    print(f"\n[EXQ-074d] MECH-117 Wanting/Liking Dissociation seed={seed}", flush=True)
    ...
    summary_markdown = (
        f"# V3-EXQ-074d -- MECH-117 Wanting/Liking Dissociation\n\n"
        f"**Status:** {status}\n**Claims:** MECH-112, MECH-117\n"
        f"**Seed:** {seed}  **Steps:** {TOTAL_STEPS}"
        f"  **Relocation:** step {RELOCATION_STEP}\n"
        f"**Fix from 074c:** CausalGridWorldV2 size=6, resource_respawn,"
