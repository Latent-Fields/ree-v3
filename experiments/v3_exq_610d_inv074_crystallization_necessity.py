...
"""V3-EXQ-610d: INV-074 crystallization necessity test (post-substrate Phase-3 enrichment retest).

Supersedes V3-EXQ-610c (FAIL; D2=False; control did not show predicted collapse ->
non_contributory per 2026-06-02 governance). This retest follows substrate
...
SUBSTRATE DEPENDENCIES (2026-06-01 retest):
  ...
  - This experiment (V3-EXQ-610d) retests with the new Phase-3 destabilizing
...
EXPERIMENT_TYPE = "v3_exq_610d_inv074_crystallization_necessity"
EXPERIMENT_PURPOSE = "evidence"
QUEUE_ID = "V3-EXQ-610d"
...
def _run_arm(arm_config: Dict, seed: int, dry_run: bool) -> Dict:
    ...
    print(
        f"[V3-EXQ-610d] Starting {arm_label} seed={seed} crystallize={crystallize}",
        flush=True,
    )
...
if __name__ == "__main__":
    ...
    # Run experiment
    print(
        f"[V3-EXQ-610d] INV-074 crystallization necessity test (EVB-0270, post-Phase-3-enrichment retest)",
        flush=True,
    )
    ...
    if not dry:
        ...
        print(f"[V3-EXQ-610d] Manifest written: {manifest_path}", flush=True)
