...
"""V3-EXQ-514j -- SD-049 Phase 2 reef behavioural validation under GAP-2 operating substrate.

goal_pipeline:GAP-2 owner EXQ. Supersedes V3-EXQ-514f (pre-MECH-307 / pre-SP-CEM confound).

Single-variable stack vs 514f (reef + phased P0/P1/P2 unchanged):
  - MECH-307 four-gap conjunction ON on ARM_1/2/3 (OFF on ARM_0_off).
  - drive_floor=0.9 on active arms (MECH-306 / V3-EXQ-582a operating point).
  - Main-path SP-CEM defaults (ARC-065; from_dims hippocampal defaults).
  - schema_wanting_enabled before select_action on MECH-307 arms.
  - Post-540e relaxed MECH-295 bridge activation floors on active arms.

Pre-registered PASS (514f reef criteria + goal_pipeline Phase 2 extensions):
...
EXPERIMENT_TYPE = "v3_exq_514j_sd049_phase2_reef_mech307_spcem"
QUEUE_ID = "V3-EXQ-514j"
CLAIM_IDS = ["SD-049", "SD-015", "MECH-229", "MECH-230", "MECH-307"]
EXPERIMENT_PURPOSE = "evidence"
SUPERSEDES = "V3-EXQ-514f"
...
def main(dry_run: bool = False):
    ...
    manifest = {
        ...
        "evidence_direction_per_claim": {
            ...
            "MECH-307": "supports" if outcome == "PASS" else "mixed",
        },
        "gap2_operating_substrate": {
        ...
        "supersedes_note": (
            "goal_pipeline:GAP-2 retest. Supersedes V3-EXQ-514f (pre-MECH-307 / pre-SP-CEM). "
            "Operating stack: MECH-307 conjunction + drive_floor=0.9 + main-path SP-CEM. "
