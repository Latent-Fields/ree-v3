...
def make_env() -> CausalGridWorldV2:
    return CausalGridWorldV2(seed=_next_env_seed(), num_hazards=3, size=8)
...
def main():
    ...
    # set the MODULE knob -- a plain assignment here would bind a local
    globals()["_ENV_SEED_BASE"] = args.env_seed
