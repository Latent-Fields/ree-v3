...
"""
V3-EXQ-847 -- ARC-062 GOV-FANOUT-1 portfolio Leg P-D (H4: MEASUREMENT ALIASING --
...
erratum sections appended to that same doc 2026-07-31. Provenance chip
chip-20260729-arc062-pd-context-modeswitch.
...
def _run_seed_arm(
    ...
    return {
        ...
        # NEW (V3-EXQ-847): count of P2 ticks where the E3 diagnostics latch was NOT
        # repopulated (a held commitment) -- the true fresh-selection denominator for
        # the MECH-448/449 diagnostics is n_p2_ticks - n_latched_ticks.
...
def main() -> Tuple[Optional[str], Optional[str], bool]:
    parser = argparse.ArgumentParser(description="V3-EXQ-847 ARC-062 GOV-FANOUT-1 Leg P-D (H4 context-conditioned mode-switch diagnostic; 654j matched stack + NEW reef/open TV-divergence DV)")
