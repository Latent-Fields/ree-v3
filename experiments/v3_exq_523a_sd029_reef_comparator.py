...
"""V3-EXQ-523a: SD-029 Reef-Unblocked Comparator with Graduation Test
...
EXPERIMENT_TYPE = "v3_exq_523a_sd029_reef_comparator"
QUEUE_ID = "V3-EXQ-523a"
CLAIM_IDS = ["SD-029", "MECH-256"]
...
def write_result(result, run_id):
    ...
    manifest = {
        ...
        "experiment_purpose": "evidence",
        "supersedes": "v3_exq_523_sd029_reef_comparator",
