...
EXPERIMENT_TYPE = "v3_exq_074c_mech112_117_wanting_liking"
...
def run(
    ...
    **kwargs,
    ...
    print(f"\n[EXQ-074c] MECH-117 Wanting/Liking Dissociation seed={seed}", flush=True)
    ...
    summary_markdown = (
        f"# V3-EXQ-074c -- MECH-117 Wanting/Liking Dissociation\n\n"
        f"**Status:** {status}\n**Claims:** MECH-112, MECH-117\n"
