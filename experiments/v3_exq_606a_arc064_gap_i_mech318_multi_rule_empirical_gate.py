...
"""V3-EXQ-606a: ARC-064 GAP-I MECH-318 empirical retire-vs-promote gate.

Supersedes V3-EXQ-606 (premature run 20260521T090253Z before GAP-B closure).
...
EXPERIMENT_TYPE = "v3_exq_606a_arc064_gap_i_mech318_multi_rule_empirical_gate"
EXPERIMENT_PURPOSE = "evidence"
QUEUE_ID = "V3-EXQ-606a"
SUPERSEDES = "V3-EXQ-606"
...
def main() -> None:
    ...
    acc = result["acceptance"]
    print("\n=== V3-EXQ-606a SUMMARY ===", flush=True)
