...
"""
V3-EXQ-490h: MECH-295 drive->liking->approach cascade Tier-1 retest under
...
Outcome interpretation grid (paste into per-claim direction at review):
  PASS (all five clear):
    ...
    -> goal_pipeline:GAP-4 advances toward closure (additionally requires
       490h to land contributory result on origin/master).
...
supersedes: V3-EXQ-490g (post-library-rebuild successor)
"""
...
EXPERIMENT_TYPE = "v3_exq_490h_mech295_cascade_gap4_tier1"
QUEUE_ID = "V3-EXQ-490h"
CLAIM_IDS = ["MECH-295"]
EXPERIMENT_PURPOSE = "evidence"
SUPERSEDES = "V3-EXQ-490g"
