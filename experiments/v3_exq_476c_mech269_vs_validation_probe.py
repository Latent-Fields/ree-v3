...
"""
V3-EXQ-476c -- MECH-269 V_s validation entropy probe (cascade gate).
...
Also fixes deprecated agent.act() API (replaced with sense()/select_action() pattern),
env.reset() unpacking, and env.step() argument (now passes full action tensor).

--- Original 476b docstring below ---
...
EXPERIMENT_TYPE = "v3_exq_476c_mech269_vs_validation_probe"
...
def main() -> int:
    ...
    output = {
        ...
        "supersedes": "v3_exq_476b_mech269_vs_validation_probe",
