...
EXPERIMENT_TYPE = "v3_exq_468d_sd034_mech268_decommit_hold_behavioural"
QUEUE_ID = "V3-EXQ-468d"
CLAIM_IDS: List[str] = ["SD-034", "MECH-268", "MECH-090"]
EXPERIMENT_PURPOSE = "diagnostic"
SUPERSEDES = "V3-EXQ-468c"
...
def _aborted_seed_record(seed: int, stage: str, reason: str) -> Dict[str, Any]:
    empty_arm = {
        ...
        "n_hook_fires": 0, "episodes_with_contradiction": 0,
