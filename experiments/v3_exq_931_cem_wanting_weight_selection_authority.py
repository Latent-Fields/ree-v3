"""V3-EXQ-931: CEM wanting_weight selection-authority dose-response (DIAGNOSTIC).
...
Run with:
  /opt/local/bin/python3 experiments/v3_exq_931_cem_wanting_weight_selection_authority.py [--dry-run]
...
EXPERIMENT_TYPE = "v3_exq_931_cem_wanting_weight_selection_authority"
EXPERIMENT_PURPOSE = "diagnostic"
CLAIM_IDS: List[str] = []
