...
"""
V3-EXQ-182 -- SD-015 Handcrafted Goal Cue Diagnostic
...
EXPERIMENT_TYPE = "v3_exq_182_sd015_handcrafted_goal_diagnostic"
CLAIM_IDS = ["SD-015"]
...
def run(
    ...
    **kwargs,
    ...
    summary_markdown = (
        f"# V3-EXQ-182 -- SD-015 Handcrafted Goal Cue Diagnostic\n\n"
        f"**Status:** {status}\n"
        f"**Claims:** SD-015\n"
        f"**Decision:** {decision}\n"
        f"**Seeds:** {list(seeds)}\n\n"
