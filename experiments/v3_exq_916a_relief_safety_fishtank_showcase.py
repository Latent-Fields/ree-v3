...
EXPERIMENT_TYPE    = "v3_exq_916a_relief_safety_fishtank_showcase"
EXPERIMENT_PURPOSE = "diagnostic"
CLAIM_IDS          = []
...
def run_seed(seed: int, dry_run: bool = False) -> Dict:
    ...
    print(
        f"[EXQ-916a] Seed {seed}  warmup={warmup_eps}  eval={eval_eps}"
    ...
    print(
        f"[EXQ-916a] Seed {seed} -- world_obs_dim={env.world_obs_dim}"
    ...
    print(
        f"[EXQ-916a] Seed {seed} channel std: "
    ...
    print(
        f"[EXQ-916a] Seed {seed} freeze_fires={ree['freeze_fires']}"
...
def run(seeds=None, dry_run: bool = False) -> dict:
    ...
    print(
        f"[V3-EXQ-916a] Relief/Safety Fishtank Showcase\n"
        f"  Seeds: {seeds}\n"
    ...
    summary_markdown = f"""# V3-EXQ-916a -- Relief/Safety Fishtank Showcase (residue_wanting writer fix)
