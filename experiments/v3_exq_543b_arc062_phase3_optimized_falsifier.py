...
"""V3-EXQ-543b: ARC-062 Phase 3-corrected Monomodal-Collapse Falsifier on SD-054 reef.

Supersedes V3-EXQ-543. Per arc_062_rule_apprehension_plan.md decision-log entry
2026-05-10 ("GAP-B reclassified non_contributory; jump to Phase 3 design").
...
-------
  ...
  evidence_direction_per_claim:
    ...
    SD-029 (monomodal-collapse measurement gate):
      "supports" if PASS (substrate enables C2/C3/C4 measurements under
        trained policy, which SD-029 retest needed)
      "weakens" if F1 (measurements unobtainable; substrate ceiling reached)
      "non_contributory" if probe gate failed OR PASS rule unmet without F1
  experiment_purpose: "evidence" (architecturally load-bearing falsifier)
  supersedes: V3-EXQ-543

Plan-of-record: REE_assembly/evidence/planning/arc_062_rule_apprehension_plan.md
GAP-B owner_exq -> V3-EXQ-543b on PASS; FAIL routes through the falsification
chain in Phase 2 deliverable 5: BG-side score-aggregation -> trajectory-
proposal-level -> ARC-063 V4 strong reading.
...
EXPERIMENT_TYPE = "v3_exq_543b_arc062_phase3_optimized_falsifier"
EXPERIMENT_PURPOSE = "evidence"
QUEUE_ID = "V3-EXQ-543b"
SUPERSEDES = "V3-EXQ-543"
CLAIM_IDS = ["MECH-309", "ARC-062", "SD-029"]
...
def _p0_warmup_train(
    ...
    for ep in range(num_episodes):
        ...
        for _ in range(steps_per_episode):
            ...
            # candidate.world_states[0] across the first N candidates.
            if (agent.gated_policy is not None
                    ...
                    and len(candidates[0].world_states) >= 1):
                first_step_world = torch.cat([
                    c.world_states[0].detach().clone()
...
def run(seeds: Optional[List[int]] = None, dry_run: bool = False) -> Dict:
    ...
    print(
        f"[V3-EXQ-543b] ARC-062 Phase 3-corrected Monomodal-Collapse Falsifier"
...
if __name__ == "__main__":
    ...
    print("\n=== V3-EXQ-543b SUMMARY ===", flush=True)
    print(
