"""
V3-EXQ-075d -- MECH-113 Self-Maintenance (z_self D_eff Framing)

Claims: MECH-113
Supersedes: V3-EXQ-075c (script deleted; all prior 075 iterations crashed due to
  compute_z_self_d_eff() and compute_self_maintenance_loss() not yet existing in
  REEAgent at time of run -- 2026-03-23. Both methods confirmed present as of
  2026-03-28.)
...
EXPERIMENT_TYPE = "v3_exq_075d_mech113_self_maintenance"
CLAIM_IDS = ["MECH-113"]
...
def _run_single(
    ...
    print(f"\n[EXQ-075d] TRAIN {cond_label} seed={seed}", flush=True)
    agent.train()
...
def run(
    ...
    **kwargs,
    ...
    print(f"\n[EXQ-075d] MECH-113 Self-Maintenance (D_eff framing)", flush=True)
    print(
    ...
    summary_markdown = (
        f"# V3-EXQ-075d -- MECH-113 Self-Maintenance (z_self D_eff)\n\n"
        f"**Status:** {status}\n**Claims:** MECH-113\n"
