...
"""
V3-EXQ-654h -- arc_062_rule_apprehension:GAP-B behavioural falsifier for
MECH-309 / ARC-062, ported onto the MECH-448 (ARC-107) RANK-PRESERVING
F->ELIGIBILITY DEMOTION conversion.

SUPERSEDES V3-EXQ-654g (FAIL non_contributory, 2026-06-19; run_id
...
NOTHING by itself. supersedes V3-EXQ-654g (CRF lineage terminus, conversion-ceiling FAIL;
654h arms the MECH-448 demotion lever that lifted the ceiling on GAP-A).
...
EXPERIMENT_TYPE = "v3_exq_654h_arc062_gapb_rule_apprehension_behavioural_falsifier"
QUEUE_ID = "V3-EXQ-654h"
    ...
    interpretation = {
        ...
        "preconditions": [
            ...
            },
            {
                ...
                # (confirmed live: 0.022601 vs 0.05). No single spread statistic CAN
                # reproduce `met`: the per-seed boolean is a CONJUNCTION
                # (consumed_spread_mean > FLOOR and consumed_dist_max < CEIL), and a
                # count over a conjunction does not distribute into per-leg counts.
                # The min-spread number is preserved as a NON-BOUND diagnostic.
...
def _build_manifest(
    ...
    return {
        ...
        "evidence_direction_note": (
            f"V3-EXQ-654h arc_062 GAP-B behavioural falsifier (MECH-309 / ARC-062), "
            f"supersedes V3-EXQ-654g (FAIL non_contributory 2026-06-19; CRF lineage "
        ...
        "config_summary": {
            ...
            "first_downstream_generalisation": "654h is the first downstream test that the MECH-448 demotion lever generalises off the GAP-A foraging substrate onto the GAP-B rule-apprehension composite -> closes behavioral_diversity_isolation:GAP-I on PASS",
            "z_goal_enabled": True,
            "drive_weight": 2.0,
            "alpha_world": 0.9,
            "reef_enabled": True,
...
def main() -> Tuple[Optional[str], Optional[str], bool]:
    parser = argparse.ArgumentParser(description="V3-EXQ-654h GAP-B falsifier (on the MECH-448 rank-preserving F->eligibility demotion conversion; supersedes 654g)")
