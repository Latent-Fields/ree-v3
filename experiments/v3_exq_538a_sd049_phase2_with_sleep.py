...
"""V3-EXQ-538a -- SD-049 Phase 2 reef behavioural validation, sleep-on ablation.
SLEEP DRIVER: K=3 multi-fire (SleepLoopManager, sleep_loop_episodes_K=3, fires every 3 episodes)

Supersedes V3-EXQ-538 (SIGTERM after ~24min on ree-cloud-1 -- 2026-05-08
silent-fail cluster with 433f/537; no manifest produced). Re-queued unchanged
...
EXPERIMENT_TYPE = "v3_exq_538a_sd049_phase2_with_sleep"
CLAIM_IDS = ["SD-049", "SD-015", "SD-017", "MECH-229", "MECH-230"]
EXPERIMENT_PURPOSE = "evidence"
SUPERSEDES = "V3-EXQ-538"
