...
REDESIGNED 5-arm behavioural retest (scored evidence). Successor to V3-EXQ-603l.
...
EXPERIMENT_TYPE = "v3_exq_603o_escape_affordance_bridge_behavioural_redesign"
...
HAZARD_STAGE_PROXIMITY_HARM = 0.15  # 603l: 0.1 (headroom lever)
...
# --- SUBSTRATE FIX 1 (603k): Stage-H harm-pathway training (FULL, unchanged) ------
