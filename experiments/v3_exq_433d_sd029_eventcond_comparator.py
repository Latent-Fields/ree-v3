...
"""
V3-EXQ-433d -- SD-029 Comparator Attenuation: Calibrated Curriculum + Balanced Eval.

Claims: SD-029, MECH-256
Supersedes: V3-EXQ-433c (C0 trials_sufficient_gate FAIL 0/4 seeds; agent_caused
trials = 0 in all seeds; env_caused trials too sparse for stable r2).
...
EXPERIMENT_TYPE = "v3_exq_433d_sd029_eventcond_comparator"
CLAIM_IDS = ["SD-029", "MECH-256"]
EXPERIMENT_PURPOSE = "evidence"
...
def main():
    ...
    output = {
        ...
        "supersedes": "v3_exq_433c_sd029_eventcond_comparator",
