...
"""
V3-EXQ-138 -- ARC-030 Go/NoGo Symmetry Discriminative Pair (Canonical Matched Seeds)
...
Note on prior evidence:
  ...
  EXQ-138 is the canonical test with corrected training depth.
...
EXPERIMENT_TYPE = "v3_exq_138_arc030_go_nogo_pair"
CLAIM_IDS = ["ARC-030"]
...
def run(
    ...
    **kwargs,
    ...
    print(
        f"\n[EXQ-138] ARC-030 Go/NoGo symmetry discriminative pair"
    ...
    print(f"\n[EXQ-138] Final results:", flush=True)
    print(
    ...
    summary_markdown = (
        f"# V3-EXQ-138 -- ARC-030 Go/NoGo Symmetry Discriminative Pair\n\n"
        f"**Status:** {status}\n"
        f"**Claims:** ARC-030\n"
        f"**Decision:** {decision}\n"
        f"**Seeds:** {list(seeds)}\n"
