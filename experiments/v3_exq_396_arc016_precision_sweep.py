"""
V3-EXQ-396 — ARC-016 Precision Threshold Sweep (hazard_harm sweep)
...
EXPERIMENT_TYPE = "v3_exq_396_arc016_precision_sweep"
...
def run(
    ...
    **kwargs,
    ...
    print(
        f"[V3-EXQ-396] ARC-016 Precision Threshold Sweep\n"
    ...
    for hazard_harm in HAZARD_HARM_LEVELS:
        print(f"\n[V3-EXQ-396] === hazard_harm={hazard_harm:.3f} ===", flush=True)
    ...
    print(f"\nV3-EXQ-396 verdict: {status}  ({n_met}/5)", flush=True)
    ...
    summary_markdown = f"""# V3-EXQ-396 — ARC-016 Precision Threshold Sweep
