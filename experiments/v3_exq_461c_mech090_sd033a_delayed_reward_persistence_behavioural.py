...
def _build_hold_env(scaffold_cfg: ScaffoldedSD054OnboardingConfig,
    ...
    LOAD-BEARING (461b never set it).    `seed` is the DRIVER-OWNED counterpart of the scheduler's `scaffold_env_seed`
