"""
V3-EXQ-652: SD-057 cue-recall -- cue-AUTHORITY GAIN SWEEP, CLEAN EVIDENCE
PARALLEL-RACE CLONE of V3-EXQ-640b (machine_affinity ree-cloud-4).

Identical design / acceptance / claim tags to V3-EXQ-640b -- queued only to run
the SAME sweep on ree-cloud-4 in parallel with the slow 640b instance on
DLAPTOP-4.local. Whichever completes first is THE evidence; the other should be
marked evidence_direction:superseded at review so SD-057/MECH-346/MECH-347 are
not double-counted in governance confidence. (Distinct QUEUE_ID + EXPERIMENT_TYPE
so the runner outcome sentinel and the written manifest do not collide with 640b.)
...
EXPERIMENT_TYPE = "v3_exq_652_scaffold_cue_authority_gain_sweep_640b_clone"
QUEUE_ID = "V3-EXQ-652"
