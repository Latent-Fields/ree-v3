...
"""
V3-EXQ-903 -- MECH-075 Ventral VTA-RPE Probe (ventral leg, FIRST attempt)
...
# Metadata
# ---------------------------------------------------------------------------
EXPERIMENT_TYPE = "v3_exq_903_mech075_ventral_vta_rpe_probe"
CLAIM_IDS = ["MECH-075"]
EXPERIMENT_PURPOSE = "evidence"
...
def _run_seed(seed: int, dry_run: bool) -> Dict[str, Any]:
    ...
    print(
        ...
        f" grounding_corr={p0a_grounding_corr:.4f}"
