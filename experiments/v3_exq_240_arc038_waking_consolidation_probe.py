...
"""
V3-EXQ-240 -- ARC-038 Waking Consolidation Mode Probe
...
EXPERIMENT_TYPE = "v3_exq_240_arc038_waking_consolidation_probe"
CLAIM_IDS = ["ARC-038"]
EXPERIMENT_PURPOSE = "diagnostic"
...
def run(
    ...
    **kwargs,
    ...
    for i, seed in enumerate(seeds):
        ...
        print(
            f"\n[V3-EXQ-240] seed={seed} env_seed={env_seed}"
    ...
    print(f"\n[V3-EXQ-240] Final results:", flush=True)
    print(
    ...
    summary_markdown = (
        f"# V3-EXQ-240 -- ARC-038 Waking Consolidation Mode Probe\n\n"
        f"**Status:** {status}\n"
        f"**Claims:** ARC-038\n"
        f"**Decision:** {decision}\n"
