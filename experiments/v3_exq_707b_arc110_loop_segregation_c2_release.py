        ...
        "preconditions": [
            ...
            },
            {
                ...
                "description": (
                    ...
                    "the NUMBER of DIVERGENT seeds on which a limbic channel is routing-live; "
                    "the per-seed test uses the SAME statistic (per-candidate range) the "
                    "load-bearing C2 ablation depends on, not a magnitude proxy."
                ),
