...
"""
V3-EXQ-654e -- arc_062_rule_apprehension:GAP-B behavioural falsifier for
...
EXPERIMENT_TYPE = "v3_exq_654e_arc062_gapb_rule_apprehension_behavioural_falsifier"
...
def _build_manifest(
    ...
    return {
        ...
        "evidence_direction_note": (
            f"V3-EXQ-654e arc_062 GAP-B behavioural falsifier (MECH-309 / ARC-062), "
            f"supersedes V3-EXQ-654d, ported onto the CRF-GATE CALIBRATION AMEND "
...
def main() -> Tuple[Optional[str], Optional[str]]:
    parser = argparse.ArgumentParser(description="V3-EXQ-654e GAP-B falsifier (on the CRF-gate calibration amend; ungated from GAP-A)")
