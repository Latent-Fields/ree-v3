...
"""V3-EXQ-606: ARC-064 GAP-I MECH-318 empirical retire-vs-promote gate.
...
Scientific gate: interpret only after V3-EXQ-543k contributory PASS (GAP-B).
...
EXPERIMENT_TYPE = "v3_exq_606_arc064_gap_i_mech318_multi_rule_empirical_gate"
...
def write_manifest(result: Dict, dry_run: bool, elapsed: float) -> Tuple[Path, str]:
    ...
    manifest = {
        ...
        "note": (
            ...
            "Interpret after V3-EXQ-543k contributory PASS."
        ),
    }
