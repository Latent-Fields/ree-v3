"""
V3-EXQ-517a: MECH-302 relief-completion discriminative pair -- recalibrated comparator.

Supersedes V3-EXQ-517.  EXQ-517 produced 0 events across all 3 seeds because the
...
EXPERIMENT_TYPE = "v3_exq_517a_mech302_relief_completion_discriminative_pair"
CLAIM_IDS = ["MECH-302"]
...
def main():
    ...
    print(f"EXQ-517a: MECH-302 recalibrated comparator", flush=True)
    print(
    ...
    manifest = {
        ...
        "claim_ids": CLAIM_IDS,
        "supersedes": "v3_exq_517_mech302_relief_completion_discriminative_pair",
        "outcome": outcome,
        ...
        "notes": (
            "MECH-302 relief-completion discriminative pair, recalibrated comparator. "
            "Supersedes EXQ-517 (0 events across all seeds: 5-step window / 0.05 threshold "
            "cannot resolve 0.002/step healing). Recalibration: window 5->30, "
            "threshold 0.05->0.005, min_norm 0.02->0.01. "
