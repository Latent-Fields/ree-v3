"""V3-EXQ-926 -- MECH-449 / ARC-107 perseveration-axis conversion falsifier.
...
EVIDENCE_DIR = Path("/Users/dgolden/REE_Working/REE_assembly/evidence/experiments")

EXPERIMENT_PURPOSE = "evidence"
EXPERIMENT_TYPE = "v3_exq_926_mech449_perseveration_nogo_falsifier"
...
def run_experiment(dry_run: bool = False) -> Dict[str, Any]:
    ...
    print(
        f"[926] outcome={outcome} label={label} conversions={seed_conversions} "
