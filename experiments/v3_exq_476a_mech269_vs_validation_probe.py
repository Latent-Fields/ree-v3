...
"""
V3-EXQ-476a -- MECH-269 V_s validation entropy probe (cascade gate).
...
Supersedes
----------
V3-EXQ-476 (stub -- never ran real body; NotImplementedError guard).
Same scientific question; real implementation landed under 476a per
ree-v3 no-ID-reuse rule.
...
EXPERIMENT_TYPE = "v3_exq_476a_mech269_vs_validation_probe"
...
def main() -> int:
    ...
    output = {
        ...
        "supersedes": "v3_exq_476_mech269_vs_validation_probe",
